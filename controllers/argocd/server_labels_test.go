...
func TestReconcileServerDeployment_WithLabels(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
	a := makeTestArgoCD(func(a *argoproj.ArgoCD) {
		a.Spec.Server.Labels = map[string]string{
...
func TestReconcileServerDeployment_WithAnnotations(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
	a := makeTestArgoCD(func(a *argoproj.ArgoCD) {
		a.Spec.Server.Annotations = map[string]string{
...
func TestReconcileServerDeployment_WithLabelsAndAnnotations(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
	a := makeTestArgoCD(func(a *argoproj.ArgoCD) {
		a.Spec.Server.Labels = map[string]string{
			"custom-label": "custom-value",
